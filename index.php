...
function convertTodayTimeAgo(string $datetime)
{
    ...
    return (int)$time . $unix;      //(int)　←←←　割り算で余った秒数を削除するために入れてる
}
...
<head>
    ...
    <link rel="icon" href="<?php echo HOME_URL; ?>Views/img/icon-search.svg">
            ...
            <div class="tweet-post">
                ...
                <div class="input-area">
                    <form action="post.php" method="post" enctype="multipart/form-data">
                        <textarea name="body" placeholder="はい" maxlength="140"></textarea>
